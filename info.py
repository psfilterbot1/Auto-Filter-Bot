...
API_ID = int(environ.get('API_ID', '27454854'))
API_HASH = environ.get('API_HASH', 'f6e80a16e2c46c32d54d49fae7f2eab0')
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7288983855').split()]  #Admin Id
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002549213713').split()] #Movie Database Channel Id
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002527150746'))  #Log Channel Id
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002527150746'))  #Streming Log Channel Id
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002608131214'))  #Movie Update Channel Id
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002527150746')) #Premium Subscription Log Channel Id
reqst_channel = environ.get('REQST_CHANNEL_ID', '  -1002677084809') #Movie Request Channel Id
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
support_chat_id = environ.get('SUPPORT_CHAT_ID', '  -1002677084809') #Support Chat Id
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://gksinghadvocate9:7czF9nfyhcXlbBds@cluster0.okqa2ik.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") #MongoDB Url
...
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+sjIjmfzTLyxkMzU9')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+3GN6JNqbP1I4ODk1')
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/doremon49868')
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/+3GN6JNqbP1I4ODk1')

#Force Subscription Channel (Put Same Channel Id In Both Veriables)
AUTH_CHANNEL = int(environ.get('AUTH_CHANNEL', '-1002640119647')) 
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002608131214'))

IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002527150746')) #Verification Channel Id 
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002527150746')) #If Anyone Set Your Bot In Any Group And Set Shortner In That Group Then In This Channel The All Details Come
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+T2W2vpB-OY42ZWE1') #Support Chat Link
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002549213713')).split()]
